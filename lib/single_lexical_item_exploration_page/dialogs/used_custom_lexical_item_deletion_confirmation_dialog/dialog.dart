...
Future<bool?> showUsedCustomLexicalItemDeletionConfirmationDialog() {
  return showAppActionDialog<bool>(
    builder: (context) {
      return Localizations.override(
        context: context,
        delegates: const [
          _UsedCustomLexicalItemDeletionConfirmationDialogTranslation.delegate,
        ],
        child: AppActionDialogTheme(
          ...
          child: Builder(
            builder: (context) {
              final translation =
                  _UsedCustomLexicalItemDeletionConfirmationDialogTranslation.of(context);
